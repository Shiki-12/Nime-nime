        ...
        <div className="mx-auto max-w-[1440px] px-4 py-8 lg:px-6">
            ...
            {saved.length === 0 && (
                <div className="py-16 text-center">
                    ...
                    <Link href="/" className="mt-4 inline-block rounded-full bg-hn-primary px-5 py-2 text-xs font-bold text-hn-dark">
                        Browse Anime
                    </Link>
                </div>
            )}
            ...
            {saved.length > 0 && (
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
                    {saved
                        ...
                        .map((anime) => (
                            <div key={anime.slug} className="group relative overflow-hidden rounded-lg bg-hn-card">
