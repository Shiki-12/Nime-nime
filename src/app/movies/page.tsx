        ...
        <div className="mx-auto max-w-[1440px] px-4 py-8 lg:px-6">
            <section className="mb-8 text-center">
                ...
                <p className="mx-auto mt-2 max-w-md text-sm text-white/40">
                    Feature-length anime films — from theatrical blockbusters to hidden gems.
                </p>
            </section>
            ...
            {animeList.length > 0 && (
                <>
                    ...
                    <div className="mt-10 flex items-center justify-center gap-2">
                        {pagination.hasPrev && (
                            <Link href={`/movies?page=${currentPage - 1}`} className="rounded-full bg-hn-card px-5 py-2 text-sm font-semibold text-white hover:bg-hn-card-hover">
                                ← Previous
                            </Link>
                        )}
